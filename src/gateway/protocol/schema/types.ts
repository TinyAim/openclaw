...
export type SubagentsListParams = SchemaType<"SubagentsListParams">;
export type SubagentsSpawnParams = SchemaType<"SubagentsSpawnParams">;
export type SubagentsKillParams = SchemaType<"SubagentsKillParams">;
